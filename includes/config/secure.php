...
else
{
	...
	if(isset($_SERVER["HTTP_REFERER"]) && (strcasecmp($_SERVER["HTTP_REFERER"], "http://localhost/ChemtronicsIndia/home.php") == 0 || strcasecmp($_SERVER["HTTP_REFERER"], "http://localhost/ChemtronicsIndia/index.php") == 0)) 
	{
		;
	}
	else
