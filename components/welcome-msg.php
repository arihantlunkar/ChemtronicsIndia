    ...
    <div class="col-md-4">
        <div class="card text-center welcome-msg">
            ...
            <div class="card-footer">
                <span class="solution-name mr-1">PROSOFT V1.3,</span> A Solution of <a href="https://www.chemtronicsindia.com/" target="_blank" class="main-website">Chemtronicsindia.com</a>
            </div>
        </div>
    </div>
</template>
